...
//#endregion
export { CodeAnalyzer, Config, ConfigParser, DriverRegistry, GraphStore, IncrementalCacheStore, LENS_PROMPT_TEXT, LensWatcher, SFCLanguageDriver, SUPPORTED_EXTENSIONS, TSLanguageDriver, TSParser, analyzeCircularDependencies, analyzeImpact, analyzeProjectMetrics, apply, buildCircularResult, buildMetricsResult, extractSFCBlocks, formatGraphMarkdown, generateMermaidDiagram, inject, kebabToPascal, name, presentLensCall, presentLensResult, resolveModulePath };
