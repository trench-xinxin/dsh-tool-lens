...
function apply(ctx, config = {}) {
	...
	ctx.tools.register(defineTool({
		name: "lens",
		description: "Inspect symbol call hierarchies, file dependencies, circular dependencies, architecture metrics, shortest call paths, dead code, git diff changes, domain slices, full-stack API contracts, and refactoring impact graphs across TypeScript, Vue, Svelte, Python, Go, Rust, and Java codebases.",
		parameters: {
			action: {
				type: "string",
				required: true,
